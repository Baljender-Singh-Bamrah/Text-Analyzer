...
const Text_convertor = () => {
    ...
    return (
        <div className='place-content-center h-screen grid'>
            ...
            <div className="mb-3">
                <textarea value={text} onChange={handleOnChange} id='myBox' placeholder='Enter text here...' className="w-3xl h-40 p-2 bg-blue-200 border-2 rounded-xl form-control"></textarea>
            </div>
